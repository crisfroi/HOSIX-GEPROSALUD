-- ============================================================
-- FASE 5 - MIGRACIONES COMBINADAS (VERSIÓN ARREGLADA)
-- Elimina políticas existentes y las recrea
-- ============================================================

-- ============================================================
-- ELIMINAR POLÍTICAS EXISTENTES (para evitar "already exists")
-- ============================================================
...
-- ============================================================
-- RECREAR TABLAS (IF NOT EXISTS evita errores si ya existen)
-- ============================================================
...
-- ============================================================
-- RECREAR POLÍTICAS (después de eliminarlas)
-- ============================================================
